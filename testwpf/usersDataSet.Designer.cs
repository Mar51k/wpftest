...
namespace testwpf.usersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([login], [password]) VALUES (@login, @password);\r\nSELE" +
                "CT user_id, login, password FROM users WHERE (user_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[users] SET [login] = @login, [password] = @password WHERE (([user_i" +
                "d] = @Original_user_id) AND ([login] = @Original_login) AND ([password] = @Origi" +
                "nal_password));\r\nSELECT user_id, login, password FROM users WHERE (user_id = @us" +
                "er_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::testwpf.Properties.Settings.Default.usersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, login, password FROM dbo.users";
        ...
        public virtual int Update(string login, string password, int Original_user_id, string Original_login, string Original_password, int user_id) {
            if ((login == null)) {
                throw new global::System.ArgumentNullException("login");
            }
            else {
        ...
        public virtual int Update(string login, string password, int Original_user_id, string Original_login, string Original_password) {
            return this.Update(login, password, Original_user_id, Original_login, Original_password, Original_user_id);
        }
    }
